    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#E7F4E8] via-[#F2F9F3] to-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <motion.div 
            className="absolute top-20 left-20 w-72 h-72 bg-primary-green/5 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.2, 0.3],
            }}
          ...
          />
          <motion.div 
            className="absolute bottom-20 right-20 w-96 h-96 bg-[#E1F0E3] rounded-full blur-3xl"
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.2, 0.3, 0.2],
            }}
        ...
        <div className="relative z-10 pt-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              <div className="relative w-32 h-32 bg-white rounded-full p-2 shadow-xl">
                <Image
                  src="/logo.png"
                  alt="EcoCircuit Logo"
                  fill
            ...
            <p className="text-xl sm:text-2xl text-gray-800 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          >
            <button className="group bg-primary-green text-white px-8 py-4 rounded-full hover:bg-primary-green/90 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl">
              <span className="flex items-center gap-2">
                Schedule Collection
                <SparklesIcon className="h-5 w-5 transition-transform group-hover:rotate-12" />
              </span>
            </button>
            <button className="group border-2 border-primary-green text-primary-green px-8 py-4 rounded-full hover:bg-primary-green hover:text-white transition-all transform hover:scale-105">
              Learn More
            </button>
          </motion.div>
          ...
          >
            <div className="bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-primary-green/20">
              <div className="bg-[#E7F4E8] w-12 h-12 rounded-full flex items-center justify-center mb-4 mx-auto">
            ...
            <div className="bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-primary-green/20">
              <div className="bg-[#E7F4E8] w-12 h-12 rounded-full flex items-center justify-center mb-4 mx-auto">
                <GlobeAltIcon className="h-6 w-6 text-primary-green" />
              </div>
              <h3 className="text-lg font-bold text-primary-green mb-2">
                Reduce CO₂ Impact
              </h3>
      ...
      <section className="py-20 bg-[#F2F9F3]">
        <Features />
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-[#F2F9F3] to-[#E7F4E8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <button className="bg-primary-green text-white px-8 py-4 rounded-full hover:bg-primary-green/90 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl">
              Get Started Today
            </button>
          </motion.div>
        </div>
